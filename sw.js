const CACHE_NAME = 'app-jantinha-v5.2';
...
const NETWORK_FIRST = ['/app.js', '/admin.js', '/admin.html', '/index.html', '/atend.html'];
...
// Permite que o novo SW assuma o controle imediatamente (sem esperar fechar abas)
